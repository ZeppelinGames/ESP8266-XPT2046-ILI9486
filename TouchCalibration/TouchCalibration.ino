...
static TS_Point _screenPoint[] = {
  TS_Point( 23,  19), // point A
  TS_Point(461, 213), // point B
  TS_Point(167, 304)  // point C
};
...
//
//static TS_Point _screenPoint[] = {
//  TS_Point(173, 20), // point A
//  TS_Point(439, 202), // point B
//  TS_Point(167, 304)  // point C
//};
//
//// touchscreen points used for calibration verification
//static TS_Point _touchPoint[] = {
//  TS_Point(2652, 3731), // point A
//  TS_Point(536, 1671), // point B
//  TS_Point(3797, 336), // point C
//};
...
void crosshair(TS_Point p) {
  tft.drawCircle   (p.x,     p.y,     6, ILI9486_WHITE);
  tft.drawFastHLine(p.x - 4, p.y,     9, ILI9486_WHITE);
  tft.drawFastVLine(p.x,     p.y - 4, 9, ILI9486_WHITE);
}
...
void drawMapping(PointID n, TS_Point tp) {
  ...
  tft.fillRect(posX, posY, sizeW, sizeH, ILI9486_BLACK);
